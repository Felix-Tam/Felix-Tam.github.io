...
/* I chose to have a variety of differant colours the user can choose between for the background as they can be personalised to the individuals liking. */

const colors = ['#fdceff','#c547ff','#b6e878','#3756dd','#dcb7ff']

body.style.backgroundColor = colors[0] 

/* by setting the background color 'colors[0]' this will make the defualt colour, the light purple when you enter the site as this is the colour that I feel works best within the composition. */
...
function changeBackground(){
  ...
  /* I decided to implement a colour shifting feature, by using the image of a keyboard to be the button that triggers the action.
  I implemented a function that will randomly change the colour of the background based on the 5 variable colour options. */
...
/* I implemented a mute and unmute feature as well as a fullscreen button to the video timeline. */
